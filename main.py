...
boot_line("  CPU: VizXtreme a7, 1.2Ghz", 5, delay=2)
boot_line("  RAM: 256MiB", 6, delay=2)
boot_line("  GPU: they/them yahocu l3s", 7, delay=2)
boot_line("  Display: 800x600 16-bit color ukriu renderer", 8, delay=2)
t.clone_frame(15)

boot_line("Beginning memory test...", 10, delay=4)

# Memory test simulation
for i in range(0, 262144, 8192):  # 256MiB Memory
    t.delete_row(10)
    t.gen_text(f"Beginning memory test... {i}KiB", 10)

t.delete_row(10)
boot_line(f"Beginning memory test...", 10)
boot_line(" 262144KiB OK", 10, color="green", contin=True)
t.clone_frame(15)
...
t.gen_text("Welcome to rickastleey's profile!", 9)
t.clone_frame(15)
t.clear_frame()
