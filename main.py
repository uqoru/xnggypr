...
boot_line("  CPU: VizXtreme v8 1.0Ghz", 5, delay=2)
boot_line("  RAM: 256MiB", 6, delay=2)
boot_line("  Display: 800x600 16-bit color ukriu v10 display", 7, delay=2)
t.clone_frame(15)
...
t.gen_text("Welcome to rickasteey's profile!", 9)
t.clone_frame(15)
t.clear_frame()
